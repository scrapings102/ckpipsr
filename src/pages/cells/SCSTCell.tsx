...
interface SCSTMember {
  role: string;
  name: string;
  designation: string;
  contact: string;
  email: string;
  category: "Leadership" | "Faculty" | "Government" | "University";
  isAddress?: boolean;
}

const scstMembers: SCSTMember[] = [
  {
    role: "Chairman",
...
export default function SCSTCell() {
  const [activeTab, setActiveTab] = useState<"committee" | "circulars" | "complaint">("committee");
  ...
  const filteredMembers = scstMembers.filter((m) => {
    const matchesSearch =
  ...
  const categories = ["All", "Leadership", "Faculty", "Government", "University"];

  return (
    <SubPageLayout
      title="SC-ST Cell"
      subtitle="Scheduled Castes and Scheduled Tribes Empowerment & Welfare Cell"
      category="cells"
      activeItemLabel="SC-ST Cell"
    >
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-slate-600 font-sans leading-relaxed">
                          {member.designation || "Government Representative"}
                        </p>
                      </div>
                    </div>

                    {/* Card Footer: Direct Contact & Office Actions */}
                    <div className="pt-3 border-t border-slate-100 space-y-2 text-xs font-sans">
                      {/* Contact: Phone or Office Address */}
                      <div className="flex items-start justify-between text-slate-700 gap-2">
                        ...
                        {member.contact && member.contact !== "-" && !member.isAddress && (
                          <button
                      ...
                      <div className="flex items-center gap-2 text-slate-700">
                        ...
                        {member.email && member.email !== "-" ? (
                          ...
                          <span className="text-slate-400 font-mono text-[11.5px]">Official Department Liaison</span>
                        )}
                      </div>
                    </div>
                  </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-200 p-8 sm:p-12 shadow-xs text-center flex flex-col items-center justify-center space-y-6">
              ...
              <div className="space-y-2 max-w-md">
                ...
                <h3 className="text-2xl font-serif font-bold text-slate-900">
                  SC-ST Cell Circulars
                </h3>
                <p className="text-xs sm:text-sm text-slate-600 font-sans leading-relaxed">
                  Access the official statutory notifications and directives issued by UGC, GTU, and AICTE.
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
                <a
                  href="https://console-navyugtrust-org.s3.ap-south-1.amazonaws.com/app/institutes/102/departments/docs/643e5e7d7ed21.pdf"
                  target="_blank"
                  rel="noreferrer noopener"
                  className="inline-flex items-center gap-2.5 px-6 py-3.5 rounded-2xl bg-[#1a5d2e] hover:bg-emerald-800 text-white font-sans font-bold text-sm shadow-sm hover:shadow-md transition-all active:scale-95 cursor-pointer"
                >
                  <FileText size={18} />
                ...
                <a
                  href="https://console-navyugtrust-org.s3.ap-south-1.amazonaws.com/app/institutes/102/departments/docs/643e5ea2cc27b.pdf"
                  target="_blank"
                  rel="noreferrer noopener"
                  className="inline-flex items-center gap-2.5 px-6 py-3.5 rounded-2xl bg-[#1a5d2e] hover:bg-emerald-800 text-white font-sans font-bold text-sm shadow-sm hover:shadow-md transition-all active:scale-95 cursor-pointer"
                >
                  <FileText size={18} />
                  <span>GTU Circular</span>
                  <ExternalLink size={15} />
                </a>

                <a
                  href="https://console-navyugtrust-org.s3.ap-south-1.amazonaws.com/app/institutes/102/departments/docs/643e5efe7df27.pdf"
                  target="_blank"
                  rel="noreferrer noopener"
                  className="inline-flex items-center gap-2.5 px-6 py-3.5 rounded-2xl bg-[#1a5d2e] hover:bg-emerald-800 text-white font-sans font-bold text-sm shadow-sm hover:shadow-md transition-all active:scale-95 cursor-pointer"
                >
                  <FileText size={18} />
                  <span>AICTE Circular</span>
                  <ExternalLink size={15} />
                </a>
              </div>
            </div>
